 ...
 */
@SuppressWarnings({"WeakerAccess", "Convert2Diamond", "unused", "UnusedAssignment"})
public final class MediaHelper {
     ...
     * @return Map<StringLong> The albums map
     */
